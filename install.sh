...
case $choice in
    1)
        clear
        cd && cd AGBSolucoes && chmod +x chatwoot.sh && ./chatwoot.sh
        ;;
    2)
        clear
        cd && cd AGBSolucoes && chmod +x evolutionapi.sh && ./evolutionapi.sh
        ;;
    3)
        clear
        cd && cd AGBSolucoes && chmod +x typebot.sh && ./typebot.sh
        ;;
    4)
        clear
        cd && cd AGBSolucoes && chmod +x n8n.sh && ./n8n.sh
        ;;
    5)
        clear
        cd && cd AGBSolucoes && chmod +x appsmith.sh && ./appsmith.sh
        ;;
    6)
        clear
        echo ""
